...
export default function TenantDetailPage() {
  ...
  const tenantId = typeof params?.tenantId === 'string' ? decodeURIComponent(params.tenantId) : null;
  ...
  return (
    <div className="lg:max-w-[1100px] mx-auto flex flex-1 min-h-0 w-full flex-col gap-6 overflow-hidden px-1 pb-4">
      <Card className="flex flex-1 min-h-0 flex-col overflow-hidden border shadow-none">
        <MainPageHeader
          title="Tenant Setup"
          description="Configure this tenant separately from Safeviate, including branding, pages, menus, and submenus."
          actions={
