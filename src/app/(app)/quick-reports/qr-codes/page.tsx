...
export default async function QuickReportQrCodesPage() {
  ...
  return (
    <div className="mx-auto flex h-full min-h-0 w-full max-w-5xl flex-col gap-4 overflow-y-auto pb-6 p-4 print:max-w-none print:overflow-visible print:p-0 print:pb-0">
      <Card className="flex flex-1 flex-col overflow-hidden border shadow-none print:border-0 print:shadow-none">
        <MainPageHeader
        ...
        <CardContent className="space-y-4 p-4 print:space-y-3">
            ...
            return (
              <Card key={card.title} className="overflow-hidden border shadow-none print:break-inside-avoid print:border">
                ...
                <CardContent className="space-y-3 p-4 text-center print:p-3">
                  ...
                  <div className="rounded-lg border bg-muted/20 px-3 py-2 text-[10px] font-black uppercase tracking-[0.14em] break-all print:hidden">
                    {card.shareUrl}
                  </div>
                  <p className="text-[10px] font-semibold uppercase tracking-[0.16em] text-muted-foreground print:hidden">
                    {card.note}
                  </p>
                </CardContent>
              </Card>
